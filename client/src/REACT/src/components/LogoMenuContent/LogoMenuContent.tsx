...
const LogoMenuContent = ({ show, onCloseClicked }: props) => {
  ...
  return (
    <>
      <Centralizer>
        <main style={{ position: "absolute", width: "70%", height: "50%", color: "white", marginTop: "-200px", userSelect: "none", zIndex: 3 }}>
      ...
      <div onClick={onCloseClicked} style={{ position: "absolute", left: "20px", top: "20px", zIndex: 3 }}>
