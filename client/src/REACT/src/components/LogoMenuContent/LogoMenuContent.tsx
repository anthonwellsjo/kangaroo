...
const LogoMenuContent = ({ show, onCloseClicked }: props) => {
  ...
  return (
    <>
      <Centralizer>
        <main style={{ position: "absolute", width: "70%", height: "50%", color: "white", marginTop: "-200px", userSelect: "none" }}>
      ...
      <div onClick={onCloseClicked} style={{ position: "absolute", left: "20px", top: "20px" }}>
        <ZoomInTransition trigger={show}>
